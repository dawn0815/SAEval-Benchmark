...
For evaluating your system, you simply need an individual predictions file for the benchmark. Here are the experimental results of [UniSA](https://github.com/dawn0815/UniSA), the first baseline for unified molding of sentiment analysis, on SAEval compared to SOTA models of various subtasks.
